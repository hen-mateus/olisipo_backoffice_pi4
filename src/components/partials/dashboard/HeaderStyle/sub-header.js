                        ...
                        <Col md="12">
                            <div className="d-flex justify-content-between flex-wrap">
                                ...
                                <div className="d-flex align-items-center">
                                    <Link to="" className="btn btn-link btn-soft-dark">
                                        <svg width="20" className="me-1" viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path opacity="1" d="M19.5313 9.82568C18.9966 9.82568 18.5626 10.2533 18.5626 10.7823C18.5626 14.3554 15.6186 17.2627 12.0005 17.2627C8.38136 17.2627 5.43743 14.3554 5.43743 10.7823C5.43743 10.2533 5.00345 9.82568 4.46872 9.82568C3.93398 9.82568 3.5 10.2533 3.5 10.7823C3.5 15.0873 6.79945 18.6413 11.0318 19.1186V21.0434C11.0318 21.5715 11.4648 22.0001 12.0005 22.0001C12.5352 22.0001 12.9692 21.5715 12.9692 21.0434V19.1186C17.2006 18.6413 20.5 15.0873 20.5 10.7823C20.5 10.2533 20.066 9.82568 19.5313 9.82568Z" fill="black"></path>
                                        </svg>
                                        Comunicados
                                    </Link>
                                </div>
